...
module.exports.run = (client, message, args) =>
  __awaiter(void 0, void 0, void 0, function*() {
    ...
    if (privateRole) privateRole = privateRole;
    if (privateHangoutChannel) privateHangoutChannel = privateHangoutChannel;
    ...
    (_a = roleMember) === null || _a === void 0
      ? void 0
      : _a.roles.add(privateRole).catch(err => {
          console.log(err);
        });
    ...
    (_b = roleMember) === null || _b === void 0
      ? void 0
      : _b.roles.remove(privateRole).catch(err => {
          console.log(err);
        });
  });
